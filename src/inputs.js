...
export class TextInput extends React.Component {
    render() {
        return ( [
            ...
            <input key="2" className="right ui-corner-all ui-widget ui-widget-content" size={ this.props.size } type="text" name={ this.props.name } onChange={this.props.onChange}/>,
        ] )
    }
}
